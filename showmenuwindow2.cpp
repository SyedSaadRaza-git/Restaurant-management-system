...
showmenuwindow2::showmenuwindow2(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::showmenuwindow2)
{
    ui->setupUi(this);
    this->showFullScreen();
...
void SortByPrice(QVector<QMap<QString, QString>> &menuData) {
    int n = menuData.size();
    bool swapped;
...
void showmenuwindow2::on_pushButton_2_clicked()
{
...
void showmenuwindow2::on_pushButton_clicked()
{
    // Create a database connection
    QSqlDatabase db=QSqlDatabase::database("restaurant_connection");
    if (!connectToDatabase()) {
...
void showmenuwindow2::on_Back_clicked()
{
    this->close();
